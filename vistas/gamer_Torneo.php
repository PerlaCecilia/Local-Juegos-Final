                  ...
                  <div class="crudAdmin" align="center">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($resTornGamer as $resTornGamer){ ?>
                        <tr>
                        <td><?php echo $resTornGamer -> id ?></td>
                        <td><?php echo $resTornGamer -> nombre ?></td>
                        <td><?php echo $resTornGamer -> juego ?></td>
                        <td><?php echo $resTornGamer -> fecha ?></td>
                        <td><?php echo $resTornGamer -> hora ?></td>
                        <td><?php echo $resTornGamer -> modalidad ?></td>
                        <td><?php echo $resTornGamer -> forma ?></td>
                        <td><?php echo $resTornGamer -> max_jugadores ?></td>
                        <td><?php echo $resTornGamer -> descripcion ?></td>
                        <td><?php echo $resTornGamer -> estatus ?></td>
