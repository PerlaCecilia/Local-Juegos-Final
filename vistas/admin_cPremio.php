          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <a href="agregarPremio.php">
                  <input type="button" name="" value="Nuevo" class="btn btn-primary">
                </a>

                <form class="" action="editPremio.php" method="post">
                  ...
                  <div class="crudAdmin" align="center">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($resultadoAdminPremio as $resultadoAdminPremio){ ?>
                        <?php $identificador = $resultadoAdminPremio -> id_premio ?>
                        <tr>
                        ...
                        <td>
                        <form method="post" action="../controladores/borrar_Premio.php">
